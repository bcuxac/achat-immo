...
_SQLITE_SCHEMA = """
        ...
        CREATE TABLE IF NOT EXISTS simulation_maps (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            date_creation TEXT NOT NULL,
            city TEXT NOT NULL,
        ...
        CREATE TABLE IF NOT EXISTS simulation_points (
            ...
            FOREIGN KEY (map_id) REFERENCES simulation_maps(id) ON DELETE CASCADE
        );

        CREATE TABLE IF NOT EXISTS map_estimate_runs (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            annonce_id INTEGER NOT NULL,
            map_id INTEGER,
            date_run TEXT NOT NULL,
            ...
            tri_p10 REAL,
            cash_on_cash_median REAL,
            first_year_cashflow_median REAL,
            first_year_cashflow_p10 REAL,
            prudent_cashflow REAL,
            cumulative_positive_probability REAL,
            tri_percentile REAL,
            missing_fields TEXT NOT NULL DEFAULT '',
            warnings TEXT NOT NULL DEFAULT '',
            FOREIGN KEY (annonce_id) REFERENCES annonces(id) ON DELETE CASCADE,
            FOREIGN KEY (map_id) REFERENCES simulation_maps(id) ON DELETE SET NULL
        );
        """
...
_POSTGRES_SCHEMA = """
        ...
        CREATE TABLE IF NOT EXISTS simulation_points (
            id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
            map_id INTEGER NOT NULL REFERENCES simulation_maps(id) ON DELETE CASCADE,
            sample_id INTEGER NOT NULL,
            surface_m2 DOUBLE PRECISION NOT NULL,
        ...
        CREATE TABLE IF NOT EXISTS map_estimate_runs (
            ...
            map_id INTEGER REFERENCES simulation_maps(id) ON DELETE SET NULL,
            date_run TEXT NOT NULL,
            simulation_hash TEXT NOT NULL,
            status TEXT NOT NULL,
            ...
            tri_p10 DOUBLE PRECISION,
            cash_on_cash_median DOUBLE PRECISION,
            first_year_cashflow_median DOUBLE PRECISION,
            first_year_cashflow_p10 DOUBLE PRECISION,
            prudent_cashflow DOUBLE PRECISION,
            cumulative_positive_probability DOUBLE PRECISION,
            tri_percentile DOUBLE PRECISION,
            missing_fields TEXT NOT NULL DEFAULT '',
            warnings TEXT NOT NULL DEFAULT ''
        );
        """
